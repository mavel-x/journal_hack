...
def main():
    ...
    argparser.add_argument('last_name', help='Фамилия')
    argparser.add_argument('first_name', help='Имя')
    ...
    full_name = f'{args.last_name} {args.first_name}'
    ...
    try:
        ...
        print(('По запросу найдено несколько учеников. Попробуйте добавить цифру и/или литеру класса. '
               '(Запустите скрипт с аргументом -h, если не знаете, как это сделать.)'))
        sys.exit()
